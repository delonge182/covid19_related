...
df_covid_msis = pd.read_excel("../Downloads/report.xls", header=14, index_col=0)
...
df_covid_msis.to_pickle('data_covid/df_age_fylke_' + store_date + '.pkl')

print("Remove from disk...")
os.remove("../Downloads/report.xls")
